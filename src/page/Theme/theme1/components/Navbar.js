...
const Navbar = (props) => {
  const { dataThme, menuActive, setMenuActive } = props;
  return (
    <NavbarContainer color={dataThme?.color}>
      <IconNavbar xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" color={dataThme?.icon_color} colorActive={dataThme?.color_menu_active} iconActive={dataThme?.icon_color_active} className={menuActive === 1 ? "active" : ""} onClick={() => setMenuActive(1)}>
      ...
      <IconNavbar xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" color={dataThme?.icon_color} colorActive={dataThme?.color_menu_active} iconActive={dataThme?.icon_color_active} className={menuActive === 2 ? "active" : ""} onClick={() => setMenuActive(2)}>
      ...
      <IconNavbar xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" color={dataThme?.icon_color} colorActive={dataThme?.color_menu_active} iconActive={dataThme?.icon_color_active} className={menuActive === 3 ? "active" : ""} onClick={() => setMenuActive(3)}>
      ...
      <IconNavbar xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" color={dataThme?.icon_color} colorActive={dataThme?.color_menu_active} iconActive={dataThme?.icon_color_active} className={menuActive === 4 ? "active" : ""} onClick={() => setMenuActive(4)}>
      ...
      <IconNavbar xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" color={dataThme?.icon_color} colorActive={dataThme?.color_menu_active} iconActive={dataThme?.icon_color_active} className={menuActive === 5 ? "active" : ""} onClick={() => setMenuActive(5)}>
